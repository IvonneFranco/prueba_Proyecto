...
public class Vista_Cliente_1 extends javax.swing.JFrame {
    ...
    public Vista_Cliente_1() {
        initComponents();
    }
    public String[] datospersonales(String[] parts) {
         partes=parts;
         return partes;
     }
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/botonsolicita.png"))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/botonestado.png"))); // NOI18N
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/select.PNG"))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      TarjetasPendientes registro = new TarjetasPendientes();
      escritorio.add(registro);
      registro.arreglo(partes);
      registro.show();
